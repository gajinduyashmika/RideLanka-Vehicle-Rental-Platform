...
VALUES
  ...
  ('e1111111-1111-1111-1111-111111111111', 
   ...
   192.00, 'COMPLETED', NOW() - INTERVAL '18 days'),
  ...
  ('e2222222-2222-2222-2222-222222222222', 
   ...
   45.00, 'COMPLETED', NOW() - INTERVAL '10 days'),
  ...
  ('e3333333-3333-3333-3333-333333333333', 
   ...
   312.00, 'COMPLETED', NOW() - INTERVAL '9 days'),
  ...
  ('e4444444-4444-4444-4444-444444444444', 
   ...
   190.00, 'CONFIRMED', NOW() - INTERVAL '3 days'),
  ...
  ('e5555555-5555-5555-5555-555555555555', 
   ...
   85.00, 'CONFIRMED', NOW() - INTERVAL '2 days'),
  ...
  ('e6666666-6666-6666-6666-666666666666', 
   ...
   CURRENT_DATE, 
   CURRENT_DATE + INTERVAL '5 days', 
   340.00, 'CONFIRMED', NOW() - INTERVAL '1 day'),
  ...
  ('e7777777-7777-7777-7777-777777777777', 
   ...
   290.00, 'CONFIRMED', NOW() - INTERVAL '12 hours'),
  ...
  ('e8888888-8888-8888-8888-888888888888', 
   ...
   CURRENT_DATE + INTERVAL '2 days', 
   CURRENT_DATE + INTERVAL '5 days', 
   78.00, 'CANCELLED', NOW() - INTERVAL '6 hours')
